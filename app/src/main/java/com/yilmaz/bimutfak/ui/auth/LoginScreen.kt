...
// AuthViewModel ile ekran arasındaki bağlantıyı kurar.
@Composable
fun LoginRoute(
    ...
    // Giriş başarılı olduğunda ana ekrana geçiş yapılmasını bildirir.
...
// Giriş ekranının yalnızca kullanıcı arayüzünü oluşturur.
@Composable
fun LoginScreen(
    uiState: AuthUiState,
